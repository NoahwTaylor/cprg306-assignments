  ...
  return(
    ...
    <section className="flex flex-col items-center rounded-lg mt-5">
      ...
      <div className="flex flex-col justify-center bg-white h-36 w-1/5 rounded-sm p-5">
        ...
        <div className="">
          <button className="w-10 h-10 bg-gray-200 hover:bg-gray-300 rounded-md mr-1.5 text-black shadow-md" onClick={() => {if(quantity > 1){setQuantity(quantity-1)}}}>-</button>
          <button className="w-10 h-10 bg-blue-500 hover:bg-blue-600 rounded-md shadow-md" onClick={() => {if(quantity < 20){setQuantity(quantity + 1)}}}>+</button>
        </div> 
